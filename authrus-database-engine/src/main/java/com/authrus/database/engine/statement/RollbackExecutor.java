...
public class RollbackExecutor extends StatementExecutor {
   
   private final Catalog catalog;
   private final Query query;
   private final String origin;
   
   public RollbackExecutor(Catalog catalog, Query query, String origin) {
   ...
   public ResultIterator<Record> execute() throws Exception {
      ...
      catalog.rollbackTransaction(origin, table);
